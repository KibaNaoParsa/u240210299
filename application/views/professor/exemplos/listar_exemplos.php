	...
	<div class="modal-dialog modal-dialog-centered" role="document" >
   	<div class="modal-content">
         ...
         <div class="modal-body">
         	<form class="form-signin" method="post" action="{url}Professor/Exemplos/add_genero/{id_genero}">
...
<div class="row justify-content-start" style="margin-bottom: 40px;">
	<button class="btn btn-primary" data-toggle="modal" data-target="#addExemploModalCenter"><i class="fas fa-plus"></i>  Adicionar Exemplo</button>
</div>
		  
<div class="modal fade" id="addExemploModalCenter" tabindex="-1" role="dialog" aria-labelledby="addExemploModalCenterTitle" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered" role="document" >
   	<div class="modal-content">
      	<div class="modal-header">
         	<h5 class="modal-title" id="addExemploModalLongTitle" style="font-size: 40px"> Adicionar Exemplo </h5>
            	<button type="button" class="close" data-dismiss="modal" aria-label="Close">
               	<span aria-hidden="true">&times;</span>
               </button>
         </div>
         <div class="modal-body">
         	<form class="form-signin" method="post" action="{url}Professor/Turma/add_turma/{id_professor}">
               	<input type="text" id="nome" name="nome" class="form-control" placeholder="Digite o nome do Exemplo!" style="font-size: 20px;" required>
            	<div class="form-group">
               </div>
               <button class="btn btn-lg btn-block btn-success" type="submit">Adicionar</button>
            </form>
...
<table class="table">
    ...
    <tbody>
        ...
        <tr>
            <th>{nome}</th>
            <th><a class="btn btn-warning btn-lgk" href="{download_url}" target="__blank">Baixar Exemplo</a></th>       
        </tr>
        {/arquivos}
    </tbody>
</table>
