...
<form method="POST" action="{url}Professor/Atividade/editar_atividade/{id_atividade}/{id_turma}/{bimestre}" class="text-right" >
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" id="nome" name="nome"  ng-required="true" value="{nome}">
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <textarea  name="descricao" type="text" id="area" >{descricao}</textarea>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input type="date" id="data_limite" class="form-control"  name="data_limite" min="{min-date}" ng-required="true"  value="{data_limite}">
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <select type="date" id="id_genero" class="form-control"  name="id_genero"  ng-required="true" >
                {opt_genero}
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <select type="date" id="id_tipo" class="form-control"  name="id_tipo" ng-required="true" >
                {opt_tipo}
                <option value="{id}" {selected}>{nome}</option>
                {/opt_tipo}
            </select>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input type="number" step="0.1" id="valor" class="form-control" ng-required="true"  name="valor"  value="{valor}" >
        </div>
    </div>
