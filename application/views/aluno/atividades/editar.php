<div class="box">
    ...
    <div class="margem">
        <form method="post" action="{url}Editar/{id_atividade}/{id}/{bimestre}" class="form-horizontal" name="form_editar">
            {atividade}
            <h2>{nome}</h2>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <textarea type="tinymce" style="class="form-control" id="conteudo" name="conteudo">{conteudo}</textarea>
                </div>
            </div>
            <div class="form-group">
